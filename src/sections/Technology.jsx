...
export default function TechnologySection() {
  ...
  useEffect(() => {
    ...
    const monitorAndInitialize = () => {
      ...
      // High-frequency updates (Progress Bar & Text) ab direct DOM manipulation se honge bina lag k
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo(".scroll", 
        { opacity: 0, y: 60 },
        { opacity: 1, y: 0, duration: 2, delay: 0.6, ease: "bounce.inOut", force3D: true,
          scrollTrigger: { trigger: sectionRef.current, start: "top 10%", toggleActions: "play none none reverse" }
        }
      )
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-12 left-16 z-20 max-w-md">
        <div className="mb-6">
          <div className="overflow-hidden mb-1">
            <h1 ref={discoverRef} className="ui-element text-7xl font-bold uppercase text-white tracking-tight leading-none opacity-0">
              Discover
            </h1>
          </div>
          <div className="overflow-hidden mb-1">
            <h2 ref={innovationRef} className="ui-element uppercase text-5xl font-bold text-red-600 tracking-tight leading-none opacity-0">
              Innovation
            </h2>
          </div>
          <div className="overflow-hidden">
            <h3 ref={perfectedRef} className="ui-element text-4xl uppercase font-bold text-white tracking-tight leading-none opacity-0">
              Perfected
            </h3>
          </div>
        </div>
        ...
        <div className="overflow-hidden mb-8">
          <h4 ref={modelNameRef} className="ui-element text-xl font-medium text-gray-400 tracking-wide uppercase opacity-0"></h4>
        </div>
      </div>
      ...
      <div className="absolute bottom-32 left-16 z-20 max-w-xs">
        <div className="overflow-hidden">
          <p ref={descriptionRef} className="ui-element text-milk-yellow text-xs leading-relaxed opacity-0 font-paragraph">
      ...
      <div className="absolute right-20 bottom-20 z-20">
        <div className="relative">
          ...
          <div ref={numberRef} className="ui-element relative text-3xl font-black text-milk-yellow opacity-0 ">
            GR
          </div>
      ...
      {/* View Mode Indicator */}
      <div ref={viewModeRef} className="view-mode-indicator absolute top-10 right-10 z-30 pointer-events-none">
        <div className="bg-black/60 backdrop-blur-lg rounded-xl p-5 border border-white/10 shadow-2xl">
          ...
          <div className="mt-4 pt-4 border-t border-white/10">
            ...
            <div className="w-full bg-gray-800 rounded-full h-2">
              ...
              <div ref={progressBarRef} className="bg-red-600 h-2 rounded-full"></div>
            </div>
      ...
      <div ref={ringAnimRef} className="absolute bottom-10 left-1/2 -translate-x-1/2 pointer-events-none z-0">
        <img
          src="/images/ring.png"
          alt="ground ring"
          className="w-[440px] opacity-60 translate-x-10 scale-x-[1.8] scale-y-[0.8] blur-[0.6px] animate-[spin_40s_linear_infinite_reverse] origin-center"
        />
      </div>
