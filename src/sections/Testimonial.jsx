...
export default function ModernTestimonialsSection() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // Create a timeline for sequence
  ...
  return (
    <section
      ref={sectionRef}
      // h-screen ensures it fits exactly one screen, overflow-hidden stops scrolling
      className="relative bg-gradient-to-b from-gray-950 to-black text-white h-screen w-full flex flex-col justify-center items-center overflow-hidden px-4"
    >
      ...
      <div className="relative z-10 max-w-7xl mt-15 h-full w-full">
        ...
        <div className="text-center mb-16 md:mb-24">
          ...
          <p 
            ref={subtitleRef}
            className="mt-6 -translate-x-98 text-milk-yellow text-md max-w-md mx-auto font-light font-paragraph"
          >
...
/>
        ...
        {/* Stats */}
        <div className="stats-container absolute scale-80 flex flex-col translate-x-135 -translate-y-80  gap-8 md:gap-8">
          {stats.map((stat, index) => (
            ...
            >
              <div className="text-5xl font-bold text-toyota-red mb-3">{stat.value}</div>
